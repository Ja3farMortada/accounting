module.exports = (app, db) => {
    ...
    app.post('/deleteInvoice', async (req, res) => {
        ...
        try {
            ...
            await connection.query(`UPDATE invoice_map SET record_status = 0 WHERE invoice_ID_FK = ?`, ID);
    ...
    app.post('/deletePayment', async (req, res) => {
        ...
        try {
            ...
            await connection.query(`UPDATE customers SET dollar_debt = (dollar_debt + ?) WHERE customer_ID = ? `, [payment.payment_value, payment.customer_ID_FK]);
            await connection.commit();
            connection.release();
            res.send('');
        } catch (error) {
